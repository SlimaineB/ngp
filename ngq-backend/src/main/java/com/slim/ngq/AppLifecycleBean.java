...
public class AppLifecycleBean {
	...
	void onStart(@Observes StartupEvent ev) {
		...
		heroRepository
				.persist(Stream.of(new Hero("Slimaine"), new Hero("Yasmine"), new Hero("Nail"), new Hero("Jean")));

		userRepository
				.persist(new User("admin", BcryptUtil.bcryptHash("admin"), "Administrator", "Administrator", null));
		userRepository.persist(new User("user", BcryptUtil.bcryptHash("admin"), "User", "User", null));
